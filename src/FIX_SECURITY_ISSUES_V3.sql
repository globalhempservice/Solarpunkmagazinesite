-- ================================================
-- SECURITY ADVISOR FIXES (V3 - Fixed company_id)
-- ================================================
-- Run this in your Supabase SQL Editor
-- Fixed: Removed spatial_ref_sys (PostGIS system table)
-- Fixed: companies_with_stats view (no company_id in user_progress)
-- ================================================
...
-- CORRECTED: user_progress doesn't have company_id
-- Just count articles for now
...
-- CHANGES IN V3:
-- ================================================
-- Fixed companies_with_stats view:
-- - Removed employee_count (user_progress has no company_id)
-- - Kept article_count only
-- - If you need employee count, you'll need to add
--   company_id column to user_progress first
-- ================================================
